  ...
  <div class="content">
   ...
   <section id="video" class="reveal fade-left">
      <div class="video-container" onclick="togglePlay(this)">
        <video id="tutorialVideo" poster="thumbnail.png" controls>
          <source src="https://drive.google.com/file/d/1Pu61kZX61fcMW9GDtr6nKamo3xw3VYDI/view?usp=sharing" type="video/mp4">
          Your browser does not support the video tag.
        </video>
        <div class="custom-toggle-btn play-button"><i class="fas fa-play"></i></div>
      </div>
      <p>If you don’t see the video, 
        <a href="https://drive.google.com/file/d/1Pu61kZX61fcMW9GDtr6nKamo3xw3VYDI/view?usp=sharing" download>click here to view or download</a>.
      </p>
  </section>
